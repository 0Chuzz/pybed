...
static const char *VER         = "BED library v. 2.5";
static const char *AUTHOR      = "By Poul Frederick Williams, Henrik Hulgaard, Henrik Reif Andersen\nEmail: {pfw,henrik,hra}@it-c.dk";
static const char *ADDR        = "IT University of Copenhagen, Denmark.";
static const char *COPYRIGHT   = "Copyright (c) 1996 - 2000 Technical University of Denmark.\nCopyright (c) 1999 - 2000 IT University of Copenhagen.";
